...
public class HtmlFieldMediatorTest {

    private HtmlFieldMediator mediator = new HtmlFieldMediator();

    @Test
    public void shouldMediateStringToTextField() {
        assertThat(mediator.getTargetType() == String.class, is(true));
        assertThat(mediator.stringify("value"), is("\"value\""));
    }
