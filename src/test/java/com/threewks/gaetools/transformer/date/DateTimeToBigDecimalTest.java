...
public class DateTimeToBigDecimalTest {

    @Rule
    public ExpectedException thrown = ExpectedException.none();
    private DateTimeToBigDecimal transformer = new DateTimeToBigDecimal();
    ...
    public void shouldTransform() {
        ...
        assertThat(transformer.from(dateTime), is(new BigDecimal(dateTime.getMillis())));
    }
}
