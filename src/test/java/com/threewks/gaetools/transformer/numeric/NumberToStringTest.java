...
public class NumberToStringTest {
    private NumberToString transformer = new NumberToString();
    ...
    public void shouldTransform() {
        ...
        assertThat(transformer.from(new BigDecimal("0.000000000000000000000000000000000012")), is("1.2E-35"));
        assertThat(transformer.from(new BigDecimal("-0.000000000000000000000000000000000012")), is("-1.2E-35"));
        assertThat(transformer.from(0), is("0"));
        assertThat(transformer.from(1), is("1"));
        assertThat(transformer.from(10), is("10"));
        assertThat(transformer.from(1234.0), is("1234.0"));
        assertThat(transformer.from(1234.0f), is("1234.0"));
        assertThat(transformer.from((short) 10), is("10"));
