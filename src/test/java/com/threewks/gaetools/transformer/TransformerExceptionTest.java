...
public class TransformerExceptionTest {
    ...
    public void shouldRetainFormattedMessage() {
        TransformerException e = new TransformerException("message %s", "parameter");
        assertThat(e.getMessage(), is("message parameter"));
        assertThat(e.getCause(), is(nullValue()));
    }
    ...
    public void shouldRetainMessageAndCause() {
        ...
        TransformerException e = new TransformerException(cause, "message %s", "parameter");
        assertThat(e.getMessage(), is("message parameter"));
